return {
  ...
  config = function()
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        if client and client:supports_method(vim.lsp.protocol.Methods.textDocument_inlayHint) then
          -- Enable inlay hints by default for all LSP servers
    ...
    local servers = {
      ...
      pylsp = {
        settings = {
          pylsp = {
            plugins = {
              pyflakes = { enabled = true },  -- Enable to show undefined names and unused imports
      ...
      graphql = { filetypes = { 'graphql', 'gpl', 'svelte', 'typescriptreact', 'javascriptreact' } },
      emmet_ls = { filetypes = { 'html', 'templ', 'typescriptreact', 'javascriptreact', 'css', 'sass', 'scss', 'less', 'svelte', 'vue' } },
      -- volar = { filetypes = { 'vue', 'javascript', 'typescript', 'javascriptreact', 'typescriptreact' } },
      -- tsserver = {},
      -- vuels = {},
      cssls = {},
      tailwindcss = {},
          ...
          json = {
            schemas = {
              ...
              },
              {
                ...
                url = 'https://json.schemastore.org/flake.lock.json',
              },
              {
          ...
          evenBetterToml = {
            schema = {
              ...
              associations = {
                ...
                ['poetry.lock'] = 'https://json.schemastore.org/poetry.json',
              },
            },
          },
        },
    ...
    -- Note: nixd is excluded because it must be installed via Nix package manager
    local ensure_installed = vim.tbl_keys(servers or {})
    vim.list_extend(ensure_installed, {
      'stylua', -- Used to format Lua code
      'gopls',
    })
    -- Remove nixd from mason installation list (install via Nix instead)
